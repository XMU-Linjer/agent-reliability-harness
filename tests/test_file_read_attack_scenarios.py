"""End-to-end tests for file read attack scenarios."""
...
SCENARIOS_DIR = Path(__file__).resolve().parent.parent / "benchmark" / "scenarios" / "file_read_attack"
...
class TestFileReadAttackScenarios:
    ...
    def test_each_trace_contains_payload_and_deny_decision(self, tmp_path: Path) -> None:
        result = BenchmarkRunner(
            SCENARIOS_DIR,
            tmp_path,
            run_id="trace-test",
