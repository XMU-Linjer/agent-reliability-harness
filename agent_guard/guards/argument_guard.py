"""
Argument checks for AgentGuard SDK.

ArgumentGuard only inspects strings from tool call arguments. It never reads real
...
from agent_guard.spec import GuardAction
...
class ArgumentGuard:
    """Detect dangerous payloads before tool execution.

    Usage::

        guard = ArgumentGuard()
        decision = guard.check_tool_call("read_file", {"path": "../../etc/passwd"})
    ...
    def check_tool_call(
        ...
        """Check a tool call without touching the real system.
        ...
        Returns:
            ArgumentGuardDecision with allow or deny.
        """
